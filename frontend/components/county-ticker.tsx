...
const tickerItems = [
  ...
  "🇰🇪 47 DEVOLVED COUNTIES REPRESENTED",
  "📜 CONSTITUTION ART. 201: CITIZEN PUBLIC PARTICIPATION IN PUBLIC FINANCE",
  "💡 PARLIAMENTARY MEMORANDUM TRACKER: YOUTH PRIORITIES SUBMITTED",
  "🏛️ DEVOLVED DESKS: MONITORING COUNTY FISCAL STRATEGY PAPERS",
  "📍 NAIROBI • MOMBASA • KISUMU • TURKANA • MACHAKOS • NAKURU",
  "🔥 UPCOMING HYBRID TOWNHALL: 12TH SEPT 2026",
];
